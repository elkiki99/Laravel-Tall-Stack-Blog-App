            ...
            <div class="p-10">
                <div class="flex items-center justify-center h-full py-10">
                    <h1 class="py-10 text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-black to-gray-700">
                        We offer a starting point for all bloggers out there to get their website 
                        <span class="underline-yellow">up and running</span>
                    </h1>
                </div>
                
                <div class="pb-10">
                    <h3 class="text-2xl font-bold">Templates</h3>

                    <div class="grid grid-cols-1 gap-5 mt-5 md:grid-cols-2 lg:grid-cols-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="mt-2 text-2xl font-bold hover:cursor-pointer">Architecture for modern people</p>
                            <p class="text-lg font-bold text-gray-500">29 may, 2024</p>
                        </div>
                        <div class="flex flex-col">
                            <div class="relative w-full pb-full">
                                <div class="absolute inset-0 overflow-hidden rounded-lg shadow-lg">
                            ...
                            <p class="mt-2 text-2xl font-bold hover:cursor-pointer">Guide to classic urbanism</p>
