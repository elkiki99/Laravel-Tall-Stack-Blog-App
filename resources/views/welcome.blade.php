<x-app-layout>      
    <div class="min-h-screen bg-gradient-to-b bg from-white via-amber-300 to-white">
        <div class="py-12">
            <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
                ...
                {{-- <p class="text-2xl">You have it all. Built in admin panel, metrics, comments, SEO curated, and much more!</p> --}}

                <div class="items-center py-5">
                    <a href="https://github.com/elkiki99/Laravel-Tall-Stack-Blog-App">
                        <x-primary-button class="text-3xl">Get started</x-primary-button>
                    </a>
                    <a href="{{ route('about') }}">
                        <x-secondary-button class="text-3xl font-thin">Learn more</x-secondary-button>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="flex items-center justify-center min-h-screen bg-fixed bg-no-repeat bg-cover" style="background-image: url('{{ asset('images/texture3.jpg') }}');">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                <div class="justify-between p-6 bg-transparent rounded-lg shadow-lg backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
                    ...
                    <p class="text-gray-500">Built-in SEO features to help your blog rank higher on search engines.</p>
                </div>
                ...
                <div class="justify-between p-6 bg-transparent rounded-lg shadow-lg backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
                    ...
                    <p class="text-gray-500">Fully responsive design to ensure your blog looks great on all devices.</p>
                </div>
                ...
                <div class="justify-between p-6 bg-transparent rounded-lg shadow-lg backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
                    ...
                    <p class="text-gray-500">Easily customizable to fit your brand's style and requirements.</p>
                </div>
                <div class="justify-between p-6 bg-transparent rounded-lg shadow-lg backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
                    ...
                    <p class="text-gray-500">Combining TailwindCSS, Alpine.js, Livewire, and Laravel for a seamless development experience.</p>
                </div>
                <div class="justify-between p-6 bg-transparent rounded-lg shadow-lg backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
                    ...
                    <p class="text-gray-500">Integrated comments section to engage with your readers.</p>
                </div>
                <div class="justify-between p-6 bg-transparent rounded-lg shadow-lg backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
                    ...
                    <p class="text-gray-500">Built-in metrics and analytics to track your blog's performance.</p>
                </div>
            </div>
        </div>
    </div>

    <div class="flex min-h-screen p-10 dark:bg-gray-900">
        <div class="grid w-1/2 grid-cols-1 gap-6 py-5">
