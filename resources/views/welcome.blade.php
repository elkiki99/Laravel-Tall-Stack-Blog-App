<x-app-layout>      
    <div class="min-h-screen bg-gradient-to-b bg from-white via-amber-200 to-white">
        <div class="py-12">
            <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
                ...
                <p class="text-2xl">This is a simple blog template for every use, you can use it as a starting point and customize it however you want. It's built with the TALL stack, TailwindCSS, Alpine.js, Livewire and Laravel.</p>

                <div class="items-center py-5">
                    <a href="https://github.com/elkiki99/Laravel-Tall-Stack-Blog-App">
                        <x-primary-button class="px-4 py-2 mx-1 text-2xl">Get started</x-primary-button>
                    </a>
                    <a href="{{ route('about') }}">
                        <x-secondary-button class="px-4 py-2 mx-1 text-2xl font-thin">Learn more</x-secondary-button>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="flex items-center justify-center min-h-screen bg-fixed bg-no-repeat bg-cover" style="background-image: url('{{ asset('images/texture3.jpg') }}');">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                <div class="justify-between p-6 transition-transform duration-300 bg-transparent rounded-lg shadow-lg hover:scale-105 backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
                    <h3 class="my-2 text-3xl font-bold text-gray-300">SEO Optimized</h3>
                    <svg class="w-12 h-12 mb-2 text-gray-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
                ...
                <div class="justify-between p-6 transition-transform duration-300 bg-transparent rounded-lg shadow-lg hover:scale-105 backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
                    ...
                    <svg class="w-12 h-12 mb-2 text-gray-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor">
                ...
                <div class="justify-between p-6 transition-transform duration-300 bg-transparent rounded-lg shadow-lg hover:scale-105 backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
                    ...
                    <svg class="w-12 h-12 mb-2 text-gray-100" viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor">
                    ...
                    <p class="text-gray-400">Combining TailwindCSS, Alpine.js, Livewire, and Laravel for a seamless development experience.</p>
                </div>
                <div class="justify-between p-6 transition-transform duration-300 bg-transparent rounded-lg shadow-lg hover:scale-105 backdrop-filter backdrop-blur-3xl dark:bg-gray-800">
    ...
    <div class="flex flex-col min-h-screen p-10 dark:bg-gray-900">
        <h2 class="relative py-5 mt-24 text-6xl font-bold text-center">Templates</h2>
        
        <div class="flex justify-center flex-1">
            <div class="grid w-1/2 grid-cols-1 gap-10 py-5">
