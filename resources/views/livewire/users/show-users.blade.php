    ...
    <div class="w-full mb-5 md:w-1/2">
        <form class="flex items-center p-1">
            ...
            <div class="relative w-full">
                ...
                <input wire:model.live="searchUsers" type="text" id="simple-search" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search users..." required="">
            </div>
        </form>
    </div>
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody>
                @foreach($users as $user)
                    <tr 
                        wire:loading.remove 
                        wire:target='deleteCategory({{ $user->id }})'
                    ...
                    />
                        ...
                        <td class="p-4">
                            <div class="flex items-end justify-end">
                                <a class="hover:blur-xs" wire:navigate href="{{ route('users.edit', $user) }}">
