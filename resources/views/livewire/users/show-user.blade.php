<div class="space-y-6 mb-20">
    ...
    @if($user->role === 'author')
        <div class="flex items-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 ml-2 text-blue-500">
    ...
    <p class="text-gray-700">
        &#64;{{ $user->nickname }} &#9679; {{ $user->posts ? $user->posts->count() . ' ' . ($user->posts->count() === 1 ? 'post' : 'posts') : '0 posts' }}
    </p>
