    ...
    <div class="w-full mb-5 md:w-1/2">
        <form class="flex items-center p-1">
            ...
            <div class="relative w-full">
                ...
                <input wire:model.live="searchTags" type="text" id="simple-search" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500" placeholder="Search tags..." required="">
            </div>
        </form>
    </div>
