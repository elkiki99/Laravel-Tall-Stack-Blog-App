<div class="min-h-screen mt-5 overflow-x-auto">
                    ...
                    />
                        ...
                        <td class="p-4 rounded-lg">
                            <div class="flex items-end justify-end">
                                <a wire:navigate href="{{ route('tags.edit', $tag) }}">
    ...
    @else
        <div class="p-6 bg-gray-100 shadow-md rounded-xl">
            <p class="text-lg">No tags created yet. 
                <a wire:navigate href="{{ route('tags.create') }}" class="font-medium text-yellow-500 hover:cursor-pointer">Create a new tag!</a>
            </p>
        </div>
    @endif
</div>