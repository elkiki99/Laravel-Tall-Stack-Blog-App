        ...
        {{-- <div class="overflow-hidden">             --}}
            <ul class="p-4 text-gray-900 dark:text-gray-100">
                <div class="relative max-w-xs my-4">
                    <input type="text" placeholder="Search..." class="w-3/4 p-2 pl-12 text-sm text-black bg-white border rounded-full">
                ...
                <li class="w-full py-1">
                    <a {{-- href="{{ route('blog.category', ['category' => 'modern-design']) }}" --}}
                        class="px-1 font-light text-black transition-all duration-300 text-md hover:cursor-pointer hover:text-gray-800 dark:hover:text-gray-100">
                        Modern Design
                    </a>
                </li>
                <li class="w-full py-1">
