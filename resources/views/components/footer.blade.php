<footer class="text-white from-black via-gray-950 bg-gradient-to-r  to-gray-900 h-[80vh] pt-20 p-16">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="grid grid-cols-3 gap-5">
                <div class="w-full p-4">
                    ...
                    <ul>
                        <li>
                            <a href="#" class="inline-flex items-center text-gray-400 hover:text-gray-200">
                ...
                <div class="w-full p-4">
                    ...
                    <ul>
                        <li><a wire:navigate href="{{ route('blog.index') }}"
                                class="text-gray-400 hover:text-gray-200">Blog</a></li>
                        <li><a wire:navigate href="{{ route('about') }}"
                                class="text-gray-400 hover:text-gray-200">About</a></li>
                        <li><a wire:navigate href="{{ route('welcome') }}"
                                class="text-gray-400 hover:text-gray-200">Home</a></li>
                        <li><a wire:navigate href="{{ route('contact') }}"
                                class="text-gray-400 hover:text-gray-200">Contact</a></li>
                        <li><a wire:navigate href="{{ route('newsletter') }}"
                                class="text-gray-400 hover:text-gray-200">Newsletter</a></li>
                    </ul>
                </div>
                <div class="w-full p-4">
