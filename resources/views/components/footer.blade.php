<footer class="text-white from-black via-gray-950 bg-gradient-to-r  to-gray-900 h-[80vh] mt-20 p-16">
    <div class="container flex flex-col justify-between h-full p-6 mx-auto">
        <div class="flex flex-wrap">
            ...
            <div class="grid grid-cols-3 gap-5">
                <div class="w-full p-4">
                    ...
                    <ul>
                        <li><a href="{{ route('blog.index') }}" class="text-gray-400 hover:text-gray-200">Blog</a></li>
                        <li><a href="{{ route('about') }}" class="text-gray-400 hover:text-gray-200">About</a></li>
                        <li><a href="{{ route('welcome') }}" class="text-gray-400 hover:text-gray-200">Home</a></li>
        ...
        <div class="flex justify-start w-full mt-auto">
            <h1 class="font-bold text-8xl">The Blog Template</h1>
        </div>    
    </div>
</footer>