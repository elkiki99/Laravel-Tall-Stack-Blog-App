<x-app-layout>
    <section class="min-h-screen px-2 mx-auto py-18 sm:py-36 max-w-7xl">
        <h1 class="mb-6 text-4xl font-bold sm:text-5xl xl:text-8xl lg:text-7xl md:text-6xl">Cookies Policy</h1>
        ...
        <ul>
            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Cookies Policy) refers to The Edifice Gazette.</li>
