    ...
    <section
        ...
        <div class="px-6 mx-auto sm:space-y-6 max-w-7xl lg:px-8">
            ...
            <p class="py-2 text-xl text-center md:text-2xl">
                ...
                stack, TailwindCSS, Alpine.js, Livewire and Laravel.
            </p>
            ...
            <div class="flex flex-col items-center justify-center py-5 space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
                <a href="https://github.com/elkiki99/Laravel-Tall-Stack-Blog-App">
                    <x-primary-button class="px-4 py-2 text-2xl rounded-lg">
                        Get started
                        <svg viewBox="0 0 256 250" width="256" height="250" class="ml-2 text-white size-6"
                            fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                            <path
        ...
        <div class="flex flex-col justify-center space-y-6 lg:flex-row lg:space-x-6 lg:space-y-0">
            <div class="w-full lg:w-1/2 ">
                <div class="bg-white rounded-lg">
                    ...
                    <div class="py-5">
                        <span
                            class="px-2 py-1 text-sm text-gray-800 bg-gray-200 rounded-full hover:cursor-pointer">Buildings</span>
                        <span
                ...
                <div class="flex flex-col py-10 space-y-10 md:flex-row md:space-y-0 md:space-x-12">
                    <div class="w-full mx-auto">
                        ...
                        <p class="text-lg leading-relaxed text-gray-700">
                            The Netherlands boasts a rich architectural heritage that spans centuries, blending
                            traditional Dutch aesthetics with innovative modern designs. In this blog post, we delve
                            deep into some of the most iconic buildings that define the architectural landscape of the
                            Netherlands.
                        </p>
                        ...
                        <p class="text-lg leading-relaxed text-gray-700">
                            ...
                            over the world. The wealth generated from trade led to the construction of grand canal
                            houses, which served as both residences and warehouses. These houses were built along the
                            iconic canals, creating a picturesque and functional urban layout.
                        </p>
                        <p class="mt-2 text-lg leading-relaxed text-gray-700">
                            One of the most striking features of these houses is their narrow width, a result of the
                            city taxing properties based on the width of the street-facing facade. This led to the
                            development of tall, narrow houses with deep interiors and multiple floors. The facades are
                            often adorned with ornate gables, each reflecting the unique style of the period in which
                            they were built.
                        </p>
                        <div class="fade-container">
                            ...
                            <p class="text-lg leading-relaxed text-gray-700">
                                ...
                                skyscrapers, such as the Erasmus Bridge and the Cube Houses, which redefine urban living
                                and design.
                            </p>
                            <p class="mt-2 text-lg leading-relaxed text-gray-700">
                                The Erasmus Bridge, nicknamed "The Swan" for its graceful, asymmetrical shape, is a
                                striking
                                symbol of the city. Spanning the Nieuwe Maas River, this bridge connects the northern
                                and
                                southern parts of Rotterdam, facilitating both pedestrian and vehicular traffic. Its
                                sleek,
