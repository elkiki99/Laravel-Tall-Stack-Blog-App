<div class="fixed flex w-1/5 h-full">
    <div class="w-16 bg-black">
        <div class="py-5">
            ...
            <a class="flex items-center justify-center my-8" wire:navigate href="{{ route('author.create') }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="size-7">
            ...
            <a class="flex items-end justify-center mt-8" wire:navigate href="{{ route('author.create') }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="size-7">
